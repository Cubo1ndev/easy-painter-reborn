...
public class EasyPainterCommand {
    ...
    private static final SimpleCommandExceptionType NOT_PREPARED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableTextContent("command.easy_painter.clearcache.not_prepared"));
